...
(function () {
  ...
  function initCarousel($block) {
    ...
    var carousels = blockElement.querySelectorAll('.hero .glider');
  ...
  if (window.acf) {
    var hookNames = ['render_block_preview/type=hero', 'render_block_preview/type=acf/hero', 'render_block_preview'];
