/******/ (() => { // webpackBootstrap
/*!******************************************!*\
  !*** ./blocks/team-grid/js/team-grid.js ***!
  \******************************************/
/**
...
(function () {
  ...
  function init() {
    var blocks = document.querySelectorAll('.team-grid');
    if (blocks.length === 0) {
      return;
    }
  ...
  function initTeamGrid(block) {
    ...
    var loadMoreBtn = block.querySelector('.team-grid-load-more');
    var itemsGrid = block.querySelector('.team-grid-items');
    if (!itemsGrid) {
      return;
    }

    // Staggered fade-in for initial items
    var initialItems = itemsGrid.querySelectorAll('.team-grid-item');
    ...
    if (loadMoreBtn && typeof teamGridData !== 'undefined') {
      loadMoreBtn.addEventListener('click', function () {
        ...
        var postsPerPage = block.getAttribute('data-posts-per-page') || '12';
...
/******/ })()
;
//# sourceMappingURL=team-grid.min.js.map