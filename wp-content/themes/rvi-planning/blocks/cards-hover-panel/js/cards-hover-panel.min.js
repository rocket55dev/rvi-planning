/******/ (() => { // webpackBootstrap
/*!**********************************************************!*\
  !*** ./blocks/cards-hover-panel/js/cards-hover-panel.js ***!
  \**********************************************************/
/**
  ...
  function initCards() {
    ...
    cards.forEach(function (card) {
      card.addEventListener('click', function (e) {
        var isOpen = this.classList.contains('panel-open');
        var clickedImage = e.target.tagName === 'IMG' || e.target.closest('img');
        var clickedPanel = e.target.closest('.hover-panel');
        if (!isOpen) {
...
/******/ })()
;
//# sourceMappingURL=cards-hover-panel.min.js.map