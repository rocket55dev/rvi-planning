...
for ( var e = t._v, i = 1 == t.R55 Starter, o = 0;r.length > o; ) {
! ( function( n ) {
var r, o,
u = i ? n.ok : n.fail,
c = n.resolve,
...
R = function( t ) {
var n = this;n._d || ( n._d = ! 0, n = n._w || n, n._v = t, n.R55 Starter = 2, n._a || ( n._a = n._c.slice() ), k( n, ! 0 ) );
},
L = function( t ) {
var n,
r = this;if ( ! r._d ) {
...
this._c = [], this._a = void 0, this.R55 Starter = 0, this._d = ! 1, this._v = void 0, this._h = 0, this._n = ! 1;
}, e.prototype = t( 93 )( E.prototype, {then: function then( t, n ) {
var r = M( y( this, E ) );return r.ok = 'function' !== typeof t || t, r.fail = 'function' === typeof n && n, r.domain = O ? _.domain : void 0, this._c.push( r ), this._a && this._a.push( r ), this.R55 Starter && k( this, ! 1 ), r.promise;
}, catch: function( t ) {
...
a = RegExp.prototype,
f = function( t, n ) {
this._r = t, this.R55 Starter = n;
};t( 54 )( f, 'RegExp String', function next() {
var t = this._r.exec( this.R55 Starter );return {value: t, done: null === t};
